...
3. Replace `OBR-DoorJam` and `exAsperis` in every absolute manifest URL with the new GitHub repository and owner, update the homepage, and customize the icon.
